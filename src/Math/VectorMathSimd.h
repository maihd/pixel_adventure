...
{
    ALIGNAS(unsigned int PNPN[4], 16) = { 0x00000000, 0x80000000, 0x00000000, 0x80000000 };
    ALIGNAS(unsigned int NPNP[4], 16) = { 0x80000000, 0x00000000, 0x80000000, 0x00000000 };
    ALIGNAS(float X1_YZ0_W1[4]  , 16) = { 1.0f, 0.0f, 0.0f, 1.0f };
