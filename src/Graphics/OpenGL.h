...
DECL_GL_FUNC(void,          glGetIntegerv, uint32_t pname, int32_t* params);
DECL_GL_FUNC(const char*,   glGetString, uint32_t pname);

DECL_GL_FUNC(void,          glScissor, int32_t x, int32_t y, int32_t w, int32_t h);
...
DECL_GL_FUNC(bool,          glIsEnabled, uint32_t mode);

DECL_GL_FUNC(void,          glBlendFunc, uint32_t sfactor, uint32_t dfactor);
DECL_GL_FUNC(void,          glBlendEquation, uint32_t equation);
DECL_GL_FUNC(void,          glBlendFuncSeparate, uint32_t srcRGB, uint32_t dstRGB, uint32_t srcAlpha, uint32_t dstAlpha);
